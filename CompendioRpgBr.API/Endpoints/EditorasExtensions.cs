...
public static class EditorasExtensions
{
    ...
    {
        app.MapGet("/Editoras", ([FromServices] DAL<Editora> dal) =>
        {
        ...
        app.MapGet("/Editoras/{nome}", ([FromServices] DAL<Editora> dal, string nome) =>
        {
        ...
        app.MapPost("/Editoras", async ([FromServices] IHostEnvironment env, [FromServices] DAL<Editora> dal, [FromBody] EditoraRequest editoraRequest) =>
        {
        ...
        app.MapDelete("/Editoras/{id}", ([FromServices] DAL<Editora> dal, int id) =>
        {
        ...
        app.MapPut("/Editoras",async ([FromServices]IHostEnvironment env, [FromServices] DAL<Editora> dal, [FromBody] EditoraRequestEdit editoraRequestEdit) =>
        {
